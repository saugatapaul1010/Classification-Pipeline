...
def train_stage1(input_params, path_dict):
    ...
    train_datagen = ImageDataGenerator(preprocessing_function=init_preprocess_func(input_params['model_name']))
    val_datagen = ImageDataGenerator(preprocessing_function=init_preprocess_func(input_params['model_name']))
    ...
    evaluation.predict_on_test(input_params, 1, path_dict)
...
def train_stage2(input_params, stage1_params, model_stg2, path_dict):
    ...
    evaluation.predict_on_test(input_params, 2, path_dict)
...
def train(input_params, path_dict):
    ...
    st=dt.now()
    model_stg1, stage1_params = train_stage1(input_params, path_dict)
